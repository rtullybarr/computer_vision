...
% SPATIAL_PYRAMID_MATCHING
    ...
    whole_image_responses = dict.optimize_weights(dictionary, reshape(feature_descriptors, [], d)', lambda);
    ...
    for i = 1:2
        for j = 1:2
            ...
            resp = dict.optimize_weights(dictionary, reshape(desc, [], d)', lambda);
