...
%     toc
%     
%     combined_features = cat(3, LSLBP_features, LSSIFT_features);
%     
...
%     
    ...
    % Training & Evaluation
     combined_model = svm.train(combined_X_train, Y_train);
    ...
    combined_predictions = svm.predict(combined_model, combined_X_test);
    errors = find(Y_test ~= combined_predictions);
