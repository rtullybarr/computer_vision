% https://www.mathworks.com/matlabcentral/fileexchange/46184-sift-feature-computation
function SIFT = sift_descriptor(img)

%SIFT_DESCRIPTOR
% img = rgb or gray level image
%
% SIFT = cell array of sift descriptors


%% Initialization
% Here, the x-axis correspond to coloum, while the y-axis correspond to row
% clear all; close all;
% img = imread('wildlife1.jpg');
